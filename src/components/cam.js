...
import { framePath, brideMain} from '../data/staticData.js'
                    ...
                    <table style={{ width: 100 + '%' }}>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button className="btn btn-warning btn-l hideMe" onClick={this.handleFullAsset} >FullAsset</button></td>
                                <td><button className="btn btn-warning btn-l hideMe" onClick={this.newProcess} >New Process</button></td>
                                <td><button className="btn btn-warning btn-l hideMe" onClick={this.detectX} >Detect X</button></td>
