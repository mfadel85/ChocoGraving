...
class Cam extends React.Component {
    ...
    minimizeSvgFile(svgFile){
        ...
        const fixedWidth = 27 * 3.7795284176/12.90; // assuming that there is no white space in the jpg image, if there is white space then it has to be handled differently
        //const scalingStr = 
